...
(function ($, window) {
    ...
    signalR.fn = signalR.prototype = {
        ...
        reconnected: function (callback) {
            ...
            /// <param name="callback" type="Function">A callback function to execute when the connection is reDocumentStored</param>
            /// <returns type="signalR" />
            var connection = this;
...
(function ($, window) {
    ...
    hubConnection.fn.init = function (url, options) {
        ...
        // Object to DocumentStore hub proxies for this connection
        connection.proxies = {};
