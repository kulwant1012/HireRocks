intellisense.annotate(jQuery, {
  ...
  'data': function() {
    /// <signature>
    ///   <summary>Returns value at named data DocumentStore for the element, as set by jQuery.data(element, name, value), or the full data DocumentStore for the element.</summary>
    ///   <param name="element" type="Element">The DOM element to query for the data.</param>
    ///   <param name="key" type="String">Name of the data DocumentStored.</param>
    ///   <returns type="Object" />
    /// </signature>
    /// <signature>
    ///   <summary>Returns value at named data DocumentStore for the element, as set by jQuery.data(element, name, value), or the full data DocumentStore for the element.</summary>
  ...
  'removeData': function() {
    /// <signature>
    ///   <summary>Remove a previously-DocumentStored piece of data.</summary>
