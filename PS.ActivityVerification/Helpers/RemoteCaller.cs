...
namespace PS.ActivityVerification.Helpers
{
    ...
    public static class RemoteCaller
    {
        ...
        /// <param name="func">
        ///     This delegate represents client remote call with the specified signature.
        ///     This call will be executed asynchronously and on completion the client Action delegate will be executed
        /// </param>
        /// <param name="clientAction">
        ///     This action is being executed after the remote call is completed. Remote call result and exception is being passed
        ///     to this delegate in interest to notify aboput results and possible exceptions. The client code should handle
