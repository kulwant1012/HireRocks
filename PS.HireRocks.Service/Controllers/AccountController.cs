...
using PS.HireRocks.Service.Models;
using PS.HireRocks.Service.Providers;
using PS.HireRocks.Service.Results;
...
namespace PS.HireRocks.Service.Controllers
{
    ...
    public class AccountController : ApiController
    {
        ...
        public LoginViewModel GetUserInfo()
        {
            ...
            model.UserName = "Client12";
            model.Password = "Client123";
